...
public class FriendshipManager {
    ...
    /**
     * 好友列表 返回的好友里包含了已拉入黑名单的好友 需要根据字段isInBlackList做筛选，isInBlackList==1 已拉入黑名单
     *
     * @param base callback List<{@link UserInfo}>
     */
     ...
     */
    public void searchFriends(OnBase<List<FriendInfo>> base, List<String> keywordList, boolean isSearchUserID, boolean isSearchNickname,
        boolean isSearchRemark) {
        Map<String, Object> params = new ArrayMap<>();
